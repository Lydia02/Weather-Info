...
if("geolocation" in navigator) {
    ...
    notificationElement.innerHTML ='<p> Browaer doesnt support geolocation </p>'
...
function displayWeather(latitude, logitude) {
    let api = `http://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${key}`
...
.then(function( data) {
    ...
    locationElement.innerHTML = `${weather.city}, ${weather.city}, ${weather.country}`
}
